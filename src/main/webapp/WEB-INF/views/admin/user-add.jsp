...
<main class="page-shell">
    <div class="page-heading">
        <div>
            ...
            <p>Tài khoản tạo mới mặc định sẽ có vai trò USER và trạng thái Hoạt động (ACTIVE).</p>
        </div>
    ...
    <section class="form-card">
        <form method="post" action="${pageContext.request.contextPath}/admin/users">
            ...
            <div class="form-group">
                ...
                <input id="username" name="username" value="${fn:escapeXml(userForm.username)}" required>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="button primary">Lưu người dùng</button>
